...
#ifndef vtkEllipseWidget_h
#define vtkEllipseWidget_h
...
public:
	...
	*/
	...
	/**
	* Return the representation as a vtkEllipseRepresentation.
	*/
	vtkEllipseRepresentation *GetEllipseRepresentation()
	{
		return reinterpret_cast<vtkEllipseRepresentation*>(this->WidgetRep);
	}
...
private:
	vtkEllipseWidget(const vtkEllipseWidget&) = delete;
	void operator=(const vtkEllipseWidget&) = delete;
};
